...
const tourSteps = [
  ...
  },
  {
    ...
    title: "Dashboard",
    subtitle: "Vítej v tvém centru kontroly",
    description: "Dashboard je tvůj přehled všeho – vidíš denní stav, poslední insighty, progress v gamification a rychlé přístupy k journalu nebo analytice. Zde okamžitě vidíš, kde tě dnes hlava sabotuje, a dostaneš přímé tipy k zlepšení konzistence.",
    cta: "Klikni na přehled a podívej se na tvůj dnešní score",
  ...
  },
  {
    ...
    icon: MessageSquare,
    title: "MindTrader AI",
    subtitle: "Tvůj osobní AI coach na psychologii",
    description: "MindTrader AI analyzuje tvé emoce, triggery a vzorce z tvých trades – není to jen chatbot, ale chytrý systém, který ti ukáže, proč děláš stejné chyby (jako revenge nebo FOMO) a navrhne fixy na míru. S ním snížíš emoční ztráty o 30–50 % bez změny strategie.",
    cta: "Zadej testovou emoci a uvidíš první insight",
  ...
  },
  {
    ...
    icon: ClipboardCheck,
    title: "Daily Tracker",
    subtitle: "Denní check-in pro tvou hlavu",
    description: "Daily Tracker je rychlý deník tvého stavu – zaznamenáš stres, připravenost, emoce před a po tradingu. To ti pomůže odhalit denní triggery a zabránit tiltu ještě předtím, než začneš tradovat, což vede k lepšímu R:R poměru.",
    cta: "Vyplň dnešní stav – trvá to 30 sekund",
  ...
  },
  {
    ...
    subtitle: "Chytrý journal tvých trades",
    description: "Trading Journal není jen zápisník – zadáš detaily trade (vstup, exit, emoce, důvod) a AI ho propojí s tvými vzorci. To ti ukáže, kde ztrácíš kvůli psychu (např. držíš ztráty příliš dlouho), a pomůže ti stát se konzistentním bez hádání.",
    cta: "Přidej testovací trade a podívej se na analýzu",
  ...
  },
  {
    ...
    subtitle: "Analýza tvé hlavy na datech",
    description: "Psychology Analytics převádí tvé data na grafy a insighty – vidíš riziko tiltu, frekvenci revenge, FOMO vzorce a jak se to projevuje v tvých výsledcích. To ti dává fakta, ne teorie, abyste snížil drawdowny o desítky procent a konečně profitoval konzistentně.",
    cta: "Podívej se na sample graf – co říká o tvém stylu?",
  ...
  },
  {
    ...
    icon: Trophy,
    title: "Gamification",
    subtitle: "Hra, která tě dělá lepším",
    description: "Gamification přidává body, badges a úrovně za konzistentní chování (např. za den bez tiltu nebo správný journal). To tě motivuje držet disciplínu dlouhodobě, jako hra, kde výhrou je tvůj reálný profit – snížíš chyby a zlepšíš mindset přirozeně.",
    cta: "Dokonči první úkol a získej svůj první badge",
  ...
  },
  {
    ...
    subtitle: "Reset po ztrátě – tvůj záchranný plán",
    description: "Loss Reset Protocol je krok-za-krokem průvodce po losing trade – pomůže ti rychle resetovat emoce, analyzovat chybu a vrátit se zpět bez revenge. To minimalizuje řetězové ztráty a pomůže ti zůstat v zelených číslech i v špatných dnech.",
    cta: "Simuluj ztrátu a spusť reset – uvidíš, jak to funguje",
