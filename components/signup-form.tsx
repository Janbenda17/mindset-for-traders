...
export function SignupForm() {
  ...
  const txt = {
    freeBanner: isEn ? "Virtual Mode FREE!" : "Virtual režim ZDARMA!",
    freeBannerSub: isEn ? "Start practicing with demo data instantly, upgrade to Live anytime" : "Začni okamžitě trenovat s demo daty, upgrade na Live kdykoliv",
    tagline: isEn ? "Start your journey to success" : "Začněte svou cestu k úspěchu",
    cardTitle: isEn ? "Create Account" : "Vytvořit účet",
    cardDesc: isEn ? "Join thousands of successful traders" : "Připojte se k tisícům úspěšných traderů",
    nameLabel: isEn ? "Full Name" : "Celé jméno",
    namePlaceholder: isEn ? "John Smith" : "Jan Novák",
    emailLabel: isEn ? "Email" : "Email",
    emailPlaceholder: isEn ? "your@email.com" : "jan@email.cz",
    passwordLabel: isEn ? "Password" : "Heslo",
    passwordPlaceholder: isEn ? "E.g: Trader2024" : "Např: Trader2024",
    passwordReqs: isEn ? "Password requirements:" : "Požadavky na heslo:",
    reqMin6: isEn ? "At least 6 characters" : "Minimálně 6 znaků",
    ...
    terms: isEn ? "terms" : "podmínkami",
    and: isEn ? "and" : "a",
    privacy: isEn ? "privacy policy" : "ochranou údajů",
    marketing: isEn ? "I want to receive trading tips and news" : "Chci dostávat trading tipy a novinky",
    creatingAccount: isEn ? "Creating account..." : "Vytvářím účet...",
    startFree: isEn ? "Start for free" : "Začít zdarma",
