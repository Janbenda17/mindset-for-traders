      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent
            ...
            sideOffset={4}
          >
            <DropdownMenuLabel className="text-xs text-muted-foreground">Aplikace</DropdownMenuLabel>
            ...
            <DropdownMenuItem className="gap-2 p-2">
              ...
              <div className="font-medium text-muted-foreground">Přidat aplikaci</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
