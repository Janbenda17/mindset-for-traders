      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        {allTrades.length === 0 && (
          <motion.div
            ...
            className="rounded-xl border border-fuchsia-500/30 bg-gradient-to-r from-fuchsia-500/10 to-purple-500/5 p-5 flex flex-col sm:flex-row sm:items-center gap-4 justify-between"
          >
            <div>
