      ...
      <div className="w-full max-w-sm">
        <Card className="border-blue-500/20 bg-slate-900/50 backdrop-blur">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">Enter your email to login to your account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin}>
              ...
              <div className="mt-4 text-center text-sm text-slate-400">
                ...
                <Link href="/auth/sign-up" className="text-blue-400 underline underline-offset-4">
                  Sign up
                </Link>
              </div>
            </form>
