...
const BADGE_TEMPLATES = [
  ...
  },
  {
    ...
    title: "Dokonalá Připravenost",
    description: "5 dní dokonalého Readiness skóre (100%)",
    icon: "⭐",
    target: 5,
    xpReward: 150,
  ...
  },
  {
    id: "zen-trader",
    title: "Zen Trader",
    description: "30 dní bez revenge trades",
    icon: "🧘",
    target: 30,
    xpReward: 300,
    category: "discipline",
  ...
  {
    id: "journal-warrior",
    title: "Válečník Deníku",
    description: "Zapsat si každý obchod po dobu 21 dní",
    icon: "📝",
    target: 21,
    xpReward: 250,
    category: "journaling",
